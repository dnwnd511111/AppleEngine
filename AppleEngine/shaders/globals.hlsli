#ifndef AP_SHADER_GLOBALS_HF
#define AP_SHADER_GLOBALS_HF
...
//	The shader compiler will take the defined name: APPLE_ENGINE_DEFAULT_ROOTSIGNATURE and use it as root signature
//	If you wish to specify custom root signature, make sure that this define is not available
//		(for example: not including this file, or using #undef APPLE_ENGINE_DEFAULT_ROOTSIGNATURE)
#define APPLE_ENGINE_DEFAULT_ROOTSIGNATURE \
...
// This the same as ap::graphics::ColorSpace
